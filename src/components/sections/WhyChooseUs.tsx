    ...
    <section className="container-site py-16 md:py-20">
      ...
      <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {values.map((v) => (
          ...
          >
            <span className="flex h-14 w-14 items-center justify-center rounded-2xl border border-brand-secondary/15 bg-brand-secondary-light text-brand-primary shadow-sm transition-all duration-200 ease-smooth group-hover:shadow-glowBlue">
        ...
        <div className="relative flex flex-col justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-brand-primary to-brand-primary-dark p-7 text-white shadow-glowBlue">
